...
- Statut : **11/19 au format oracle (23/09).** lab-09-modules : barrel type-only + export de valeur sous `verbatimModuleSyntax`, 11 tests. lab-10-utility-types : DTO Member dérivés (Omit/Pick/Partial/indexed access/Record exhaustif), 9 tests. lab-11-durcir-une-base-any (fusion des anciens 11-13) : EventBus any → generics+indexed access+mapped type interne, zéro régression sur le consommateur existant, 7 tests. Reste 14, 19.
