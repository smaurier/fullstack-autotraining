...
- Statut : **10/19 au format oracle (23/09).** lab-09-modules : barrel type-only + export de valeur sous `verbatimModuleSyntax`, 11 tests. lab-10-utility-types : DTO Member dérivés (Omit/Pick/Partial/indexed access/Record exhaustif), 9 tests. Reste 11, 14, 19.
